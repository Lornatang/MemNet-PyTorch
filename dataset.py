...
class TrainValidImageDataset(Dataset):
    ...
    def __getitem__(self, batch_index: int) -> [torch.Tensor, torch.Tensor]:
        ...
        lr_tensor = imgproc.image2tensor(lr_image, False, False)
        hr_tensor = imgproc.image2tensor(hr_image, False, False)
...
class TestImageDataset(Dataset):
    ...
    def __init__(self, image_dir: str, upscale_factor: int) -> None:
